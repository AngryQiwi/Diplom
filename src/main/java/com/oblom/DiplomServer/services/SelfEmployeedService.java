...
public class SelfEmployeedService {
    ...
    public CategoriesService getCategory() {
        return category;
    }

    public void setCategory(CategoriesService category) {
    ...
    public SelfEmployeedService(int self_employeed_id, String l_name, String f_name, String m_name, Date birthdate, int itn, long card_number, long phone, CategoriesService category, String brief, double rating, String photo) {
        this.self_employeed_id = self_employeed_id;
        this.l_name = l_name;
        this.f_name = f_name;
        this.m_name = m_name;
